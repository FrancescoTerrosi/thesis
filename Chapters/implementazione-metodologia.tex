...
The failure of the strategies that relied on the Monitor, doesn't allow us to analyze how the effectiveness of the Monitor is influenced by those strategies. However, the monitoring activity can still be performed on $C_{S0}$ and $C_{S1}$ to observe:
...
The monitoring activity is basically a repetition of \textsl{phase 1} and \textsl{phase 2}.
