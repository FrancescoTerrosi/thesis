...
As we expected, the MTTF of the first checkpoint is very low (20 seconds) and increases over Checkpoints. Surprisingly, the second Checkpoint has a higher MTTF than Checkpoints 3 and 4. However, analyzing some of the runs in which the second Checkpoint performed better, it could be seen that its driving was more dangerous than the other two. This resulted in reckless runs, with sudden steers and disrespect of road rules.
