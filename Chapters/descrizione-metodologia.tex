...
The Safety Monitor can be designed following the needs of the global development process. In this work, we considered a simple Safety Monitor in charge of \textsl{detecting} hazardous events, and \textsl{preventing} the failure to happen. This component reads data from the LiDAR sensor and, if the car is going too fast towards an obstacle, brake before crashing.


\section{Experiments Introduction and Preliminaries}

The first prerequisite is to have $c$ checkpoints of the Controller to be tested. 
