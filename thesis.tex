...
%--------------------------------------------------------------
\newcommand{\myItalianTitle}{Development of a monitoring methodology for autonomous vehicles managed by a Controller and a Safety-Monitor\xspace}
...
\include{Chapters/stato-dell-arte}
\include{Chapters/descrizione-metodologia}
\include{Chapters/implementazione-metodologia}
